...
const EventDetails = () => {
    ...
    const handleJoinEvent = async () => {
        ...
        try {
            ...
            setHasJoined(true);
            // Optionally refresh event data or manually update local state if needed
        } catch (error) {
    ...
    return (
        <div className="font-display bg-background-light min-h-screen flex justify-center text-text-dark">
            <div className="relative flex min-h-screen w-full flex-col max-w-[430px] overflow-x-hidden shadow-xl">
                ...
                <div className="relative -mt-10 z-10 bg-background-light rounded-t-[2.5rem] px-4 pt-8 pb-32">
                    ...
                    {hasJoined ? (
                        <div className="py-2">
                            ...
                            <div className="flex gap-4 overflow-x-auto no-scrollbar -mx-4 px-4 pb-4">
                                {/* Keeping hardcoded generic images for demo purposes as requested, but logic is ready for real data */}
                        ...
                        <div className="py-8 text-center bg-white rounded-2xl border border-border-light mx-4 mb-4">
            ...
            <nav className="fixed bottom-0 left-0 w-full h-auto bg-white/90 backdrop-blur-xl border-t border-border-light px-6 pb-3 pt-3 flex justify-center z-50">
